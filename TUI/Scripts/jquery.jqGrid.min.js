...
*/
/*  CA2: this js has been customized to include the 'NaN/NaN/NaN' FIX for date fields in jqGrids in SPRING_MVC!!
 *  this fix MUST BE PROPOGATED to newer versions of jquery.jqGrid.min js, IF & WHEN upgraded !!!
 * >>>Search for "CA2: 'NaN/NaN/NaN' fix for date fields in SPRING_MVC" in 'jquery.jqGrid.min.js' for the fix<<<
 */
...
f.match(a):null,a=function(a,b){a=""+a;for(b=parseInt(b,10)||2;a.length<b;)a="0"+a;return a},g={m:1,d:1,y:1970,h:0,i:0,s:0,u:0},h=0,i,k,h=function(a,b){0===a?12===b&&(b=0):12!==b&&(b+=12);return b};void 0===e&&(e=b.jgrid.formatter.date);void 0===e.parseRe&&(e.parseRe=/[Tt\\\/:_;.,\t\s-]/);e.masks.hasOwnProperty(d)&&(d=e.masks[d]);if(f&&null!=f)
// CA2: 'NaN/NaN/NaN' fix for date fields in SPRING_MVC - START
...
// CA2: 'NaN/NaN/NaN' fix for date fields in SPRING_MVC - FINISH
if(!isNaN(f-0)&&"u"===(""+d).toLowerCase())h=new Date(1E3*parseFloat(f));else if(f.constructor===Date)h=f;else if(null!==j)h=new Date(parseInt(j[1],10)),j[3]&&
